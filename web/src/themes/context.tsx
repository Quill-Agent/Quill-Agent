...
const STORAGE_KEY = "quill-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `quill_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "quill-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-quill-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-quill-theme-font", "true");
