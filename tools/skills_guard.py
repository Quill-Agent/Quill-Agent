...
Trust levels:
  - builtin:   Ships with Quill. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.quill/\.env|\~/\.quill/\.env',
     "quill_env_access", "critical", "exfiltration",
     "directly references Quill secrets file"),
    ...
    (r'\.quill/config\.yaml|\.quill/SOUL\.md',
     "quill_config_mod", "critical", "persistence",
     "references Quill configuration files directly"),
