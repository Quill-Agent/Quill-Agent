...
the get_anchored_view / get_messages_around primitives in quill_state.
...
# Third-party integrations tag their sessions with QUILL_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from quill_state import DEFAULT_DB_PATH
