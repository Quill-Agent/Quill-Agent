...
projection into Quill' display, approval bridging, transcript projection into
...
"codex_app_server"`. Quill' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("QUILL_KANBAN_TASK"):
            kanban_db = spawn_env.get("QUILL_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "QUILL_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("QUILL_HOME", os.path.expanduser("~/.quill")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "quill",
        client_title: str = "Quill Agent",
