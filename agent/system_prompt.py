...
upstream prefix cache warm.  See ``quill-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Quill never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want QUILL_HOME persona while keeping
    ...
    # Pointer to the quill-agent skill + docs for user questions about Quill itself.
    stable_parts.append(QUILL_AGENT_HELP_GUIDANCE)
    ...
    # QUILL_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the quill-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Quill never rebuilds or reinjects parts of it
