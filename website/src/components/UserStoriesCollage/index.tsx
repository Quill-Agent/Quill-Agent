  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Quill Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Quill &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Quill?{' '}
        <a
          href="https://github.com/YOUR_USERNAME/quill-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/YOUR_USERNAME" target="_blank" rel="noopener noreferrer">
          Quill Agent Discord
        </a>{' '}
