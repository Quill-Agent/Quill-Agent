...
const config: Config = {
  ...
  url: 'https://quill-agent.example.com',
  baseUrl: '/docs/',

  organizationName: 'YOUR_USERNAME',
  projectName: 'quill-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/YOUR_USERNAME/quill-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/quill-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://quill-agent.example.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/YOUR_USERNAME/quill-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/YOUR_USERNAME',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/YOUR_USERNAME' },
            { label: 'GitHub Discussions', href: 'https://github.com/YOUR_USERNAME/quill-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/YOUR_USERNAME/quill-agent' },
            { label: 'Quill Agent', href: 'https://example.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://example.com">Quill Agent</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
