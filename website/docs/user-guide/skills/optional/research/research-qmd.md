...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/research/qmd` |
...
Quill Agent via the native MCP client. This is the preferred
...
Then configure Quill Agent to connect via HTTP:
