...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Quill Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $QUILL_OSINT_CACHE/icij/ (default: ~/.cache/quill-osint/icij/).
...
# Set QUILL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
