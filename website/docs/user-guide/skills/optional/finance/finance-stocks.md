...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Quill Agent |
| License | MIT |
...
```
SCRIPT=~/.quill/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.quill/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
