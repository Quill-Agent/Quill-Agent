...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Quill Agent |
| License | MIT |
...
The script reads `~/.quill/.env` for two optional defaults:
...
Helper script: `~/.quill/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.quill/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.quill/.env`.
...
```bash
python3 ~/.quill/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.quill/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
