...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Quill Agent |
| License | MIT |
...
Helper script path: `~/.quill/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.quill/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.quill/skills/blockchain/evm/scripts/evm_client.py stats
```
