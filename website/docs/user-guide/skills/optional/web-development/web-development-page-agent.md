...
- User wants **Quill itself to drive a browser** → use Quill' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
