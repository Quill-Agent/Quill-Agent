...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/YOUR_USERNAME/quill-agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/YOUR_USERNAME/quill-agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
