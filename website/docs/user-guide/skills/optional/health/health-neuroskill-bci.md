...
| | |
|---|---|
| Source | Optional — install with `quill skills install official/health/neuroskill-bci` |
...
Connect Quill to a running [NeuroSkill](https://neuroskill.com/) instance to read
