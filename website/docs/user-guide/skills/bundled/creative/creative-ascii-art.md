...
```bash
python3 -m pyfiglet "QUILL" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=QUILL&font=Slant" | boxes -d stone
```
