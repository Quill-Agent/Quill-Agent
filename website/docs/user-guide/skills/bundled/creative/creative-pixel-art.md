...
```python
import sys
sys.path.insert(0, "/home/teknium/.quill/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.quill/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Quill installs package this)
