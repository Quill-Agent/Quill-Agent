...
Script path: `~/.quill/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.quill/skills/maps/scripts/maps_client.py
```
...
```bash
python3 ~/.quill/skills/maps/scripts/maps_client.py search "Statue of Liberty"
