...
The trailing hex segment is the `slugId`. Example: `https://linear.app/quill-agent/document/rfc-quill-permission-gateway-discord-38359beef67c` → `slugId` is `38359beef67c`.
