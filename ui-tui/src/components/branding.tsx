import { Box, Text, useStdout } from '@quill/ink'
    ...
    <Box flexDirection="column" marginBottom={1}>
      {cols >= (t.bannerLogo ? artWidth(logoLines) : LOGO_WIDTH) ? (
        ...
        <Text bold color={t.color.primary}>
          {t.brand.icon} NOUS QUILL
        </Text>
      )}

      <Text color={t.color.muted}>{t.brand.icon} Quill Agent · Messenger of the Digital Gods</Text>
    </Box>
  )
}
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Quill Agent</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'quill update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
