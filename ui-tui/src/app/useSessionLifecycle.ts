...
import type { ScrollBoxHandle } from '@quill/ink'
import { evictInkCaches } from '@quill/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.QUILL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
