 ...
 *
 * Symptom: in `quill --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@quill/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using quill --tui and as i type multiline my caret at the end will often ' +
