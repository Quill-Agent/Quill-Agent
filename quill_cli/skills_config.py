"""
Skills configuration for Quill Agent.
`quill skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.quill/config.yaml under:
...
from quill_cli.config import cfg_get, load_config, save_config
from quill_cli.colors import Colors, color
from quill_cli.platforms import PLATFORMS as _PLATFORMS
