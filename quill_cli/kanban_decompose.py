...
Invoked by ``quill kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Quill Agent board.
...
def _profile_author() -> str:
    """Mirror of ``quill_cli.kanban._profile_author``."""
    return (
