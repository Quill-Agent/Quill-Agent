...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'quill cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: quill gateway install", Colors.DIM))
        print(color("                    sudo quill gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    quill gateway install    # Install as a user service")
        print("    sudo quill gateway install --system  # Linux servers: boot-time system service")
        print("    quill gateway            # Or run in foreground")
