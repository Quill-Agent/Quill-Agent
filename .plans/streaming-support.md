# Streaming LLM Response Support for Quill Agent
...
```
QUILL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("QUILL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `quill_cli/config.py` | 1 | +streaming config defaults |
