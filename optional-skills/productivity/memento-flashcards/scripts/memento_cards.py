...
Data file: $QUILL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_QUILL_HOME = Path(os.environ.get("QUILL_HOME", Path.home() / ".quill"))
DATA_DIR = _QUILL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
