...
Config: ~/.quill/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.quill/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_quill_home()`` helper (QUILL_HOME-aware and
...
RULES_FILE = get_quill_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_quill_home() / "feishu_comment_pairing.json"
