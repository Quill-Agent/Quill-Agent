...
try:
    ...
    _QUILL_VERSION = "0.0.0"

_APP_VERSION = _QUILL_VERSION
_BOT_VERSION = _QUILL_VERSION
_YUANBAO_INSTANCE_ID = str(QUILL_INSTANCE_ID)  # single source: yuanbao_proto.QUILL_INSTANCE_ID
