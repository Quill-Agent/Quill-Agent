...
The main() function in quill_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `quill -c model`
...
def _build_parser():
    """Build a minimal replica of the quill top-level parser."""
