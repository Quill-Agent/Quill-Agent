"""Regression: quill doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at quill_cli/doctor.py already covers
Anthropic with the right headers, so the pluggable profile must be
skipped by `_build_apikey_providers_list()`.

See: YOUR_USERNAME/quill-agent#22346
"""
