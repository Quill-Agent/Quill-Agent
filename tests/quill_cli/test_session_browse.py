"""Tests for the interactive session browser (`quill sessions browse`).
...
from quill_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """quill sessions browse should be parseable."""
        from quill_cli.main import main as _main_entry
