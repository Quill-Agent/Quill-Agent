"""Tests for `quill curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import quill_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated QUILL_HOME with real agent-created skills on disk."""
    home = tmp_path / ".quill"
    skills = home / "skills"
    ...
    from quill_cli import curator as curator_cli
