"""Tests for quill_cli.status model/provider display."""
...
def test_show_status_reports_managed_nous_features(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("quill_cli.status.managed_nous_tools_enabled", lambda: True)
    from quill_cli import status as status_mod
...
def test_show_status_hides_nous_subscription_section_when_feature_flag_is_off(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("quill_cli.status.managed_nous_tools_enabled", lambda: False)
    from quill_cli import status as status_mod
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "quill_cli.models.probe_lmstudio_models",
