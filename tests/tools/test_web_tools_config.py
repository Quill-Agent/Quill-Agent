...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_quill_home_override(self, tmp_path):
        """Auth lookup should read from QUILL_HOME/auth.json, not ~/.quill/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".quill").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``quill tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
