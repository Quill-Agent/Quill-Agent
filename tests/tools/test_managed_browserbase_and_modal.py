...
def _enable_managed_nous_tools(monkeypatch):
    ...
    quill_cli.auth and quill_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("quill_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("quill_cli.models.check_nous_free_tier", lambda: False)
