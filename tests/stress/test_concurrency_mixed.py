...
def worker_loop(worker_id: int, quill_home: str, result_file: str) -> None:
...
def reclaimer_loop(quill_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="quill_mixed_stress_")
    print(f"QUILL_HOME = {home}")
