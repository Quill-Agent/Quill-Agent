...
class TestGoogleWorkspaceCredentialFiles:
    ...
    def test_entries_are_registered_when_files_exist(self, tmp_path):
        ...
        (quill_home / "google_client_secret.json").write_text("{}")
        ...
        try:
            ...
            assert "/root/.quill/google_token.json" in container_paths
            assert "/root/.quill/google_client_secret.json" in container_paths
        finally:
            clear_credential_files()
