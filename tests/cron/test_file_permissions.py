...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("quill_cli.config.get_config_path", return_value=config_path), \
             patch("quill_cli.config.ensure_quill_home"):
    ...
    def test_ensure_quill_home_sets_0700(self):
        home = Path(self.tmpdir) / ".quill"
        with patch("quill_cli.config.get_quill_home", return_value=home):
