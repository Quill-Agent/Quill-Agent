#!/usr/bin/env python3
"""Build the Quill Skills Index — a centralized JSON catalog of all skills.
...
`quill skills search/install` can use it without hitting the GitHub API.
...
# Ensure QUILL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Quill Skills Index...", flush=True)
