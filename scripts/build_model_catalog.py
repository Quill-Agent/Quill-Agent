...
Quill CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Quill release.
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://quill-agent.example.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
