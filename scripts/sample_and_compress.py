...
DEFAULT_DATASETS = [
    "YOUR_USERNAME/swe-terminus-agent-glm-kimi-minimax",
    "YOUR_USERNAME/quill-agent-megascience-sft1",
    "YOUR_USERNAME/Quill-Agent-Thinking-GLM-4.7-SFT2",
    "YOUR_USERNAME/Quill-Agent-Thinking-GLM-4.7-SFT1",
    "YOUR_USERNAME/terminal-tasks-glm-quill-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "YOUR_USERNAME/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload YOUR_USERNAME/{output_name} {final_output}")
