# Quill Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.quill/plugins/quill-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.quill/plugins/quill-achievements/scan_checkpoint.json`.
