...
Built for [Quill Agent](https://github.com/YOUR_USERNAME/quill-agent). Usable in any coding agent. Canonical source lives here; synced to [`YOUR_USERNAME/quill-agent/skills/creative/ascii-video`](https://github.com/YOUR_USERNAME/quill-agent/tree/main/skills/creative/ascii-video) via PR.
