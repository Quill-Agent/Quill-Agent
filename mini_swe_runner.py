#!/usr/bin/env python3
"""
SWE Runner with Quill Trajectory Format

A runner that uses Quill-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Quill-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Quill-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Quill format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Quill-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Quill-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Quill Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Quill-Agent's built-in execution environments
    and outputs trajectories in Quill-Agent format.
    """
    ...
    def _convert_to_quill_format(
        ...
        """
        Convert internal message format to Quill trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Quill trajectory format
        trajectory = self._convert_to_quill_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Quill trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Quill Trajectory Format")
    print("=" * 60)
